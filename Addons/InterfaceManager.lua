...
local InterfaceManager = {} do
    ...
    function InterfaceManager:SaveSettings()
        local success, err = pcall(writefile, self.Folder .. "/options.json", httpService:JSONEncode(InterfaceManager.Settings))
        if not success then
            warn("InterfaceManager: Failed to save settings: " .. tostring(err))
        end
    end

    function InterfaceManager:LoadSettings()
        local path = self.Folder .. "/options.json"
        local fileOk, fileExists = pcall(isfile, path)
